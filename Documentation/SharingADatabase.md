...
4. **SQLEnclave** database observation misses changes performed by external processes.
...
SQLEnclave [Database Observation] features, as well as its [Combine publishers] and [RxSQLEnclave], are not able to notify database changes performed by other processes.
...
[RxSQLEnclave]: https://github.com/RxSwiftCommunity/RxSQLEnclave
