...
> :point_up: **Note**: most code examples will be trivial, and not very "useful". This is because the goal of this guide is to stay focused on the SQLEnclave support for CTEs. Rich setup would just be distracting. So bring your own good ideas with you!
...
SQLEnclave [associations] define "to-one" and "to-many" relationships between two database tables. Here we will define associations between regular tables and common table expressions.
