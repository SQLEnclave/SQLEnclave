...
/// This protocol is an implementation detail of SQLEnclave. Don't use it.
///
/// :nodoc:
...
/// This conformance is an implementation detail of SQLEnclave. Don't rely on it.
///
/// :nodoc:
...
/// Reserved for SQLEnclave: do not use.
@inline(__always)
@inlinable
func SQLEnclavePrecondition(
