...
public struct SQLRequest<RowDecoder> {
    ...
    /// the user, and one "internal" for the statements generated by SQLEnclave. Those
    /// are separated so that SQLEnclave has no opportunity to inadvertently modify
    /// the arguments of user's cached statements.
    enum Cache {
        /// The public cache, for library user
        case `public`
        
        /// The internal cache, for SQLEnclave
        case `internal`
    }
