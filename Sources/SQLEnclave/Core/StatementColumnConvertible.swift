...
/// `DatabaseValueConvertible`. SQLEnclave will then automatically apply the
...
public protocol StatementColumnConvertible {
    ...
    /// `nil` for failed conversions: SQLEnclave will interpret a nil result as a
    /// decoding failure.
    ///
...
public final class FastDatabaseValueCursor<Value: DatabaseValueConvertible & StatementColumnConvertible> : Cursor {
    ...
    public func next() throws -> Value? {
        ...
        case SQLITE_DONE:
            ...
            return nil
        case SQLITE_ROW:
            // TODO SQLEnclave6: don't crash on decoding errors
