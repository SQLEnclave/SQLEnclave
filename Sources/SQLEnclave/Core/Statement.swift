...
public final class Statement {
    ...
    func bind<T: StatementBinding>(_ value: T, at index: CInt) {
        ...
        // They should thus succeed, unless a SQLEnclave bug: there is no point throwing any error.
        guard code == SQLITE_OK else {
    ...
    func clearBindings() {
        ...
        // This function call should thus succeed, unless a SQLEnclave bug: there is
...
extension Statement {
    ...
    /// C function.
    public func makeCursor(arguments: StatementArguments? = nil) throws -> some Cursor {
        try makeStatementCursor(arguments: arguments)
    }

    func makeStatementCursor(arguments: StatementArguments? = nil) throws -> StatementCursor {
