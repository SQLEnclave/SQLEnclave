/// A ForeignKey helps building associations when SQLEnclave can't infer a foreign
...
/// database schema. SQLEnclave will complain with a fatal error such as "Ambiguous
...
public struct ForeignKey: Equatable {
    ...
    /// foreign key. When nil (the default), SQLEnclave automatically uses the
    /// primary key.
