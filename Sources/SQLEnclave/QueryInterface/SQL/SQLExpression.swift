...
public struct SQLExpression {
    ...
    private enum Impl {
        ...
        /// Future versions of SQLEnclave may use [row values](https://www.sqlite.org/rowvalue.html).
        ///
        ///     id
        ///     rowid
        ///     code
    ...
    struct UnaryOperator: Hashable {
        ...
        /// If true SQLEnclave puts a white space between the operator and the operand.
...
extension SQLExpression {
    ...
    func sql(_ context: SQLGenerationContext, wrappedInParenthesis: Bool = false) throws -> String {
        ...
        case .fastPrimaryKey:
            // Likely a SQLEnclave bug: how comes this expression is used before it
            // has been qualified?
...
public protocol SQLSpecificExpressible: SQLExpressible, SQLSelectable, SQLOrderingTerm {
    ...
    // Swift standard type or any user type. It is only adopted by SQLEnclave types,
