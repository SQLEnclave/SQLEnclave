...
public protocol MutablePersistableRecord: EncodableRecord, TableRecord {
    ...
    /// for both insertions and updates, and has SQLEnclave generate regular
...
extension MutablePersistableRecord {
    ...
    /// updates, which has SQLEnclave generate regular INSERT and UPDATE queries.
...
final class DAO<Record: MutablePersistableRecord> {
    ...
    init(_ db: Database, _ record: Record) throws {
        ...
        SQLEnclavePrecondition(!persistenceContainer.isEmpty, "\(type(of: record)): invalid empty persistence container")
    }
