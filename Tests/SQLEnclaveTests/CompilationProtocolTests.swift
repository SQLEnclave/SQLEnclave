...
// SQLEnclave 1.2 has shipped with a change in the DatabaseReader public protocol.
//
...
// indeed RxSQLEnclave had to be modified in order to accomodate SQLEnclave 1.2.
//
