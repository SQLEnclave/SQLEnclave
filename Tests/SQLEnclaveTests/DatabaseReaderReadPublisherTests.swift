...
class DatabaseReaderReadPublisherTests : XCTestCase {
    ...
    //     frame #2: 0x000000010d926309 SQLEnclave`outlined init with copy of Subscribers.Completion<A.Publisher.Failure> at <compiler-generated>:0
    //     frame #3: 0x000000010d92474b SQLEnclave`ReceiveValuesOnSubscription._receive(completion=failure, self=0x00000001064c13c0) at ReceiveValuesOn.swift:184:9
    //     frame #4: 0x000000010d92392c SQLEnclave`closure #1 in closure #1 in closure #1 in ReceiveValuesOnSubscription.receive(self=0x00000001064c13c0, completion=failure) at ReceiveValuesOn.swift:158:26
    ...
    //     frame #14: 0x000000010961363d SQLEnclaveOSXTests`XCTestCase.wait<R>(publisherExpectation=SQLEnclaveOSXTests.PublisherExpectations.Recording<Swift.Array<SQLEnclave.Row>, Swift.Error> @ 0x00007ffeefbfd2f0, timeout=1, description="", self=0x0000000101d8a9c0) at PublisherExpectation.swift:97:9
    //     frame #15: 0x000000010915dbcf SQLEnclaveOSXTests`test #1 (reader=0x000000010672f210, self=0x0000000101d8a9c0) in DatabaseReaderReadPublisherTests.testReadPublisherError() at DatabaseReaderReadPublisherTests.swift:62:33
    //     frame #16: 0x000000010915dfc0 SQLEnclaveOSXTests`partial apply for test #1 (reader:) in DatabaseReaderReadPublisherTests.testReadPublisherError() at <compiler-generated>:0
    //     frame #17: 0x000000010915c334 SQLEnclaveOSXTests`thunk for @escaping @callee_guaranteed (@guaranteed DatabaseReader) -> (@error @owned Error) at <compiler-generated>:0
    //     frame #18: 0x000000010915e014 SQLEnclaveOSXTests`thunk for @escaping @callee_guaranteed (@guaranteed DatabaseReader) -> (@error @owned Error)partial apply at <compiler-generated>:0
    //     frame #19: 0x00000001095a85f8 SQLEnclaveOSXTests`closure #1 in Test.init(context=0x000000010672f210, _0=<unavailable>, test=0x000000010915e000 SQLEnclaveOSXTests`reabstraction thunk helper from @escaping @callee_guaranteed (@guaranteed SQLEnclave.DatabaseReader) -> (@error @owned Swift.Error) to @escaping @callee_guaranteed (@in_guaranteed SQLEnclave.DatabaseReader) -> (@error @owned Swift.Error)partial apply forwarder with unmangled suffix ".16" at <compiler-generated>) at Support.swift:13:41
    //     frame #20: 0x00000001095a86af SQLEnclaveOSXTests`partial apply for closure #1 in Test.init(repeatCount:_:) at <compiler-generated>:0
    //     frame #21: 0x00000001095a8a8f SQLEnclaveOSXTests`Test.run(context=0x000000010915e880 SQLEnclaveOSXTests`reabstraction thunk helper from @callee_guaranteed () -> (@owned SQLEnclave.DatabaseReader, @error @owned Swift.Error) to @escaping @callee_guaranteed () -> (@out SQLEnclave.DatabaseReader, @error @owned Swift.Error)partial apply forwarder with unmangled suffix ".17" at <compiler-generated>, self=(repeatCount = 1, test = 0x00000001095a8690 SQLEnclaveOSXTests`partial apply forwarder for closure #1 (A, Swift.Int) throws -> () in SQLEnclaveOSXTests.Test.init(repeatCount: Swift.Int, _: (A) throws -> ()) -> SQLEnclaveOSXTests.Test<A> at <compiler-generated>)) at Support.swift:24:17
    //   * frame #22: 0x000000010915d4ec SQLEnclaveOSXTests`DatabaseReaderReadPublisherTests.testReadPublisherError(self=0x0000000101d8a9c0) at DatabaseReaderReadPublisherTests.swift:71:14
    //     frame #23: 0x000000010915f26a SQLEnclaveOSXTests`@objc DatabaseReaderReadPublisherTests.testReadPublisherError() at <compiler-generated>:0
