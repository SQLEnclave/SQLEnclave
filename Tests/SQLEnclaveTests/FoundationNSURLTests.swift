...
class FoundationNSURLTests: SQLEnclaveTestCase {
    ...
    func testNSURLDatabaseRoundTrip() throws {
        ...
        XCTAssertTrue(try roundTrip(NSURL(string: "https://github.com/sqlenclave/SQLEnclave")!))
    ...
    func testNSURLDatabaseValueRoundTrip() {
        ...
        XCTAssertTrue(roundTrip(NSURL(string: "https://github.com/sqlenclave/SQLEnclave")!))
