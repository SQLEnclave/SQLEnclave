...
class FoundationURLTests: SQLEnclaveTestCase {
    ...
    func testURLDatabaseRoundTrip() throws {
        ...
        XCTAssertTrue(try roundTrip(URL(string: "https://github.com/sqlenclave/SQLEnclave")!))
    ...
    func testURLDatabaseValueRoundTrip() {
        ...
        XCTAssertTrue(roundTrip(URL(string: "https://github.com/sqlenclave/SQLEnclave")!))
