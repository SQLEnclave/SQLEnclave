...
class AssociationPrefetchingSQLTests: SQLEnclaveTestCase {
        ...
        try dbQueue.read { db in
            ...
            do {
                ...
                XCTAssertEqual(selectQueries, [
                    ...
                    """,
                    """
                    SELECT DISTINCT "colb2", "colb2" AS "sqldb_colb2" \
                    FROM "b" \
                    WHERE "colb2" IN (1, 2, 3) \
                    ORDER BY "colb2"
                    """])
        ...
        try dbQueue.write { db in
            ...
            do {
                ...
                XCTAssertEqual(selectQueries, [
                    ...
                    """,
                    """
                    WITH "sqldb_base" AS (SELECT "parentA", "parentB" FROM "parent") \
                    SELECT *, "pA" AS "sqldb_pA", "pB" AS "sqldb_pB" \
                    FROM "child" WHERE ("pA", "pB") IN "sqldb_base"
                    """])
            }
            ...
            do {
                ...
                XCTAssertEqual(selectQueries, [
                    ...
                    """,
                    """
                    WITH "sqldb_base" AS (SELECT "parentA", "parentB" FROM "parent" WHERE "parentA" = 'foo') \
                    SELECT *, "pA" AS "sqldb_pA", "pB" AS "sqldb_pB" \
                    FROM "child" \
                    WHERE ("name" = 'foo') AND (("pA", "pB") IN "sqldb_base")
                    """])
            }
        }
    }
        ...
        try dbQueue.read { db in
            ...
            do {
                ...
                XCTAssertEqual(selectQueries, [
                    ...
                    """,
                    """
                    SELECT *, "colc2" AS "sqldb_colc2" \
                    FROM "c" \
                    WHERE "colc2" IN (1, 2, 3) \
                    ORDER BY "colc1"
                    """,
                    """
                    SELECT *, "cold2" AS "sqldb_cold2" \
                    FROM "d" \
        ...
        try dbQueue.write { db in
            ...
            do {
                ...
                XCTAssertEqual(selectQueries, [
                    ...
                    WHERE ("pA", "pB") IN "sqldb_base"\
                    ) \
                    SELECT *, "cA" AS "sqldb_cA", "cB" AS "sqldb_cB" \
                    FROM "grandChild" WHERE ("cA", "cB") IN "sqldb_base"
                    """])
            }
            ...
            do {
                ...
                XCTAssertEqual(selectQueries, [
                    ...
                    SELECT *, "pA" AS "sqldb_pA", "pB" AS "sqldb_pB" \
                    FROM "child" \
                    WHERE 0 AND (("pA", "pB") IN "sqldb_base")
                    """])
            }
            ...
            do {
                ...
                XCTAssertEqual(selectQueries, [
                    ...
                    """,
                    """
                    WITH "sqldb_base" AS (SELECT "parentA", "parentB" FROM "parent" WHERE "name" = 'foo') \
                    SELECT *, "pA" AS "sqldb_pA", "pB" AS "sqldb_pB" \
                    FROM "child" WHERE ("name" = 'blue') AND (("pA", "pB") IN "sqldb_base")
                    """,
                    """
                    WITH "sqldb_base" AS (\
                    WITH "sqldb_base" AS (SELECT "parentA", "parentB" FROM "parent" WHERE "name" = 'foo') \
                    SELECT "childA", "childB" FROM "child" \
                    WHERE ("name" = 'blue') AND (("pA", "pB") IN "sqldb_base")\
                    ) \
                    SELECT *, "cA" AS "sqldb_cA", "cB" AS "sqldb_cB" \
                    FROM "grandChild" \
                    WHERE ("name" = 'dog') AND (("cA", "cB") IN "sqldb_base")
                    """])
            }
        }
    }
        ...
        try dbQueue.read { db in
            ...
            do {
                ...
                XCTAssertEqual(selectQueries, [
                    ...
                    """,
                    """
                    SELECT "c".*, "c"."colc2" AS "sqldb_colc2", "d".* \
                    FROM "c" \
            ...
            do {
                ...
                XCTAssertEqual(selectQueries, [
                    ...
                    """,
                    """
                    SELECT "c".*, "c"."colc2" AS "sqldb_colc2", "d1".*, "d2".* \
                    FROM "c" \
        ...
        try dbQueue.read { db in
            ...
            do {
                ...
                XCTAssertEqual(selectQueries, [
                    ...
                    """,
                    """
                    SELECT "d".*, "c"."colc2" AS "sqldb_colc2" \
                    FROM "d" \
        ...
        try dbQueue.write { db in
            ...
            do {
                ...
                XCTAssertEqual(selectQueries, [
                    ...
                    """,
                    """
                    SELECT "c".*, "a"."cola1" AS "sqldb_cola1" \
        ...
        try dbQueue.write { db in
            ...
            do {
                ...
                XCTAssertEqual(selectQueries, [
                    ...
                    """,
                    """
                    SELECT *, "colc2" AS "sqldb_colc2" FROM "c" WHERE "colc2" IN (1, 2, 3)
                    """])
            }
        ...
        try dbQueue.write { db in
            ...
            do {
                ...
                XCTAssertEqual(selectQueries, [
                    ...
                    """,
                    """
                    SELECT "b".*, "c"."colc1" AS "sqldb_colc1" \
                    FROM "b" \
        ...
        try dbQueue.write { db in
            ...
            do {
                ...
                XCTAssertEqual(selectQueries, [
                    ...
                    """,
                    """
                    SELECT MAX("score"), "parentId" AS "sqldb_parentId" \
                    FROM "player" \
                    WHERE "parentId" = 1 \
                    GROUP BY "category"
                    """])
            ...
            do {
                ...
                XCTAssertEqual(selectQueries, [
                    ...
                    """,
                    """
                    SELECT "player".*, "player"."parentId" AS "sqldb_parentId" \
                    FROM "player" \
            ...
            do {
                ...
                XCTAssertEqual(selectQueries, [
                    ...
                    """,
                    """
                    SELECT "player".*, COUNT(DISTINCT "award"."awardId") AS "awardCount", "player"."parentId" AS "sqldb_parentId" \
                    FROM "player" \
                    LEFT JOIN "award" ON "award"."playerId" = "player"."playerId" \
                    WHERE "player"."parentId" = 1 \
                    GROUP BY "player"."playerId"
        ...
        try dbQueue.write { db in
            ...
            do {
                ...
                XCTAssertEqual(selectQueries, [
                    ...
                    """,
                    """
                    SELECT DISTINCT *, "parentId" AS "sqldb_parentId" \
                    FROM "player" \
                    WHERE "parentId" = 1
                    """])
            }
        ...
        try dbQueue.write { db in
            ...
            do {
                ...
                XCTAssertEqual(selectQueries, [
                    ...
                    """,
                    """
                    SELECT *, "parentId" AS "sqldb_parentId" \
                    FROM "player" \
                    WHERE "parentId" = 1 \
                    LIMIT 10 OFFSET 5
                    """])
