...
class AssociationPrefetchingRowTests: SQLEnclaveTestCase {
        ...
        try dbQueue.read { db in
            ...
            do {
                ...
                do {
                    ...
                    XCTAssertEqual(rows[0].prefetchedRows["bs"]![0], ["colb1": 4, "colb2": 1, "colb3": "b1", "sqldb_colb2": 1])
                    XCTAssertEqual(rows[0].prefetchedRows["bs"]![1], ["colb1": 5, "colb2": 1, "colb3": "b2", "sqldb_colb2": 1])
                    ...
                    XCTAssertEqual(rows[1].prefetchedRows["bs"]![0], ["colb1": 6, "colb2": 2, "colb3": "b3", "sqldb_colb2": 2])
                ...
                do {
                    ...
                    XCTAssertEqual(row.prefetchedRows["bs"]![0], ["colb1": 4, "colb2": 1, "colb3": "b1", "sqldb_colb2": 1])
                    XCTAssertEqual(row.prefetchedRows["bs"]![1], ["colb1": 5, "colb2": 1, "colb3": "b2", "sqldb_colb2": 1])
                }
            }
            ...
            do {
                ...
                do {
                    ...
                    XCTAssertEqual(rows[0].prefetchedRows["bs1"]![0], ["colb1": 4, "colb2": 1, "colb3": "b1", "sqldb_colb2": 1])
                    XCTAssertEqual(rows[0].prefetchedRows["bs2"]!.count, 1)
                    XCTAssertEqual(rows[0].prefetchedRows["bs2"]![0], ["colb1": 5, "colb2": 1, "colb3": "b2", "sqldb_colb2": 1])
                    ...
                    XCTAssertEqual(rows[1].prefetchedRows["bs2"]![0], ["colb1": 6, "colb2": 2, "colb3": "b3", "sqldb_colb2": 2])
                }
                ...
                do {
                    ...
                    XCTAssertEqual(row.prefetchedRows["bs1"]![0], ["colb1": 4, "colb2": 1, "colb3": "b1", "sqldb_colb2": 1])
                    XCTAssertEqual(row.prefetchedRows["bs2"]!.count, 1)
                    XCTAssertEqual(row.prefetchedRows["bs2"]![0], ["colb1": 5, "colb2": 1, "colb3": "b2", "sqldb_colb2": 1])
                }
            }
        }
    }
        ...
        try dbQueue.read { db in
            ...
            do {
                ...
                do {
                    ...
                    XCTAssertEqual(rows[0].prefetchedRows["cs"]![0].unscoped, ["colc1": 7, "colc2": 1, "sqldb_colc2": 1])
                    ...
                    XCTAssertEqual(rows[0].prefetchedRows["cs"]![0].prefetchedRows["ds"]![0], ["cold1": 10, "cold2": 7, "cold3": "d1", "sqldb_cold2": 7])
                    
                    XCTAssertEqual(rows[1].unscoped, ["cola1": 2, "cola2": "a2"])
                    XCTAssertEqual(rows[1].prefetchedRows.keys, ["cs"])
                    XCTAssertEqual(rows[1].prefetchedRows["cs"]!.count, 2)
                    XCTAssertEqual(rows[1].prefetchedRows["cs"]![0].unscoped, ["colc1": 8, "colc2": 2, "sqldb_colc2": 2])
                    ...
                    XCTAssertEqual(rows[1].prefetchedRows["cs"]![0].prefetchedRows["ds"]![0], ["cold1": 11, "cold2": 8, "cold3": "d2", "sqldb_cold2": 8])
                    XCTAssertEqual(rows[1].prefetchedRows["cs"]![0].prefetchedRows["ds"]![1], ["cold1": 12, "cold2": 8, "cold3": "d3", "sqldb_cold2": 8])
                    XCTAssertEqual(rows[1].prefetchedRows["cs"]![1].unscoped, ["colc1": 9, "colc2": 2, "sqldb_colc2": 2])
                    ...
                    XCTAssertEqual(rows[1].prefetchedRows["cs"]![1].prefetchedRows["ds"]![0], ["cold1": 13, "cold2": 9, "cold3": "d4", "sqldb_cold2": 9])
                ...
                do {
                    ...
                    XCTAssertEqual(row.prefetchedRows["cs"]![0].unscoped, ["colc1": 7, "colc2": 1, "sqldb_colc2": 1])
                    ...
                    XCTAssertEqual(row.prefetchedRows["cs"]![0].prefetchedRows["ds"]![0], ["cold1": 10, "cold2": 7, "cold3": "d1", "sqldb_cold2": 7])
                }
            }
            ...
            do {
                ...
                do {
                    ...
                    XCTAssertEqual(rows[0].prefetchedRows["cs2"]![0].unscoped, ["colc1": 7, "colc2": 1, "sqldb_colc2": 1])
                    ...
                    XCTAssertEqual(rows[0].prefetchedRows["cs2"]![0].prefetchedRows["ds2"]![0], ["cold1": 10, "cold2": 7, "cold3": "d1", "sqldb_cold2": 7])
                    
                    XCTAssertEqual(rows[1].unscoped, ["cola1": 2, "cola2": "a2"])
                    XCTAssertEqual(rows[1].prefetchedRows.keys, ["cs1", "cs2"])
                    XCTAssertEqual(rows[1].prefetchedRows["cs1"]!.count, 2)
                    XCTAssertEqual(rows[1].prefetchedRows["cs1"]![0].unscoped, ["colc1": 8, "colc2": 2, "sqldb_colc2": 2])
                    ...
                    XCTAssertEqual(rows[1].prefetchedRows["cs1"]![0].prefetchedRows["ds1"]![0], ["cold1": 11, "cold2": 8, "cold3": "d2", "sqldb_cold2": 8])
                    XCTAssertEqual(rows[1].prefetchedRows["cs1"]![0].prefetchedRows["ds2"]!.count, 1)
                    XCTAssertEqual(rows[1].prefetchedRows["cs1"]![0].prefetchedRows["ds2"]![0], ["cold1": 12, "cold2": 8, "cold3": "d3", "sqldb_cold2": 8])
                    XCTAssertEqual(rows[1].prefetchedRows["cs1"]![1].unscoped, ["colc1": 9, "colc2": 2, "sqldb_colc2": 2])
                    ...
                    XCTAssertEqual(rows[1].prefetchedRows["cs1"]![1].prefetchedRows["ds2"]![0], ["cold1": 13, "cold2": 9, "cold3": "d4", "sqldb_cold2": 9])
                    XCTAssertEqual(rows[1].prefetchedRows["cs2"]!.count, 1)
                    XCTAssertEqual(rows[1].prefetchedRows["cs2"]![0].unscoped, ["colc1": 8, "colc2": 2, "sqldb_colc2": 2])
                    ...
                    XCTAssertEqual(rows[1].prefetchedRows["cs2"]![0].prefetchedRows["ds1"]![0], ["cold1": 11, "cold2": 8, "cold3": "d2", "sqldb_cold2": 8])
                    XCTAssertEqual(rows[1].prefetchedRows["cs2"]![0].prefetchedRows["ds2"]!.count, 1)
                    XCTAssertEqual(rows[1].prefetchedRows["cs2"]![0].prefetchedRows["ds2"]![0], ["cold1": 12, "cold2": 8, "cold3": "d3", "sqldb_cold2": 8])
                }
                ...
                do {
                    ...
                    XCTAssertEqual(row.prefetchedRows["cs2"]![0].unscoped, ["colc1": 7, "colc2": 1, "sqldb_colc2": 1])
                    ...
                    XCTAssertEqual(row.prefetchedRows["cs2"]![0].prefetchedRows["ds2"]![0], ["cold1": 10, "cold2": 7, "cold3": "d1", "sqldb_cold2": 7])
                }
            }
        }
    }
        ...
        try dbQueue.read { db in
            ...
            do {
                ...
                do {
                    ...
                    XCTAssertEqual(rows[1].prefetchedRows["cs"]![1].unscoped, ["colc1": 8, "colc2": 2, "sqldb_colc2": 2])
                    ...
                    XCTAssertEqual(rows[1].prefetchedRows["cs"]![2].unscoped, ["colc1": 9, "colc2": 2, "sqldb_colc2": 2])
        ...
        try dbQueue.read { db in
            ...
            do {
                ...
                do {
                    ...
                    XCTAssertEqual(rows[0].prefetchedRows["ds"]![0], ["cold1": 10, "cold2": 7, "cold3": "d1", "sqldb_colc2": 1])
                    
                    XCTAssertEqual(rows[1].unscoped, ["cola1": 2, "cola2": "a2"])
                    XCTAssertEqual(rows[1].prefetchedRows.keys, ["ds"])
                    XCTAssertEqual(rows[1].prefetchedRows["ds"]!.count, 3)
                    XCTAssertEqual(rows[1].prefetchedRows["ds"]![0], ["cold1": 11, "cold2": 8, "cold3": "d2", "sqldb_colc2": 2])
                    XCTAssertEqual(rows[1].prefetchedRows["ds"]![1], ["cold1": 12, "cold2": 8, "cold3": "d3", "sqldb_colc2": 2])
                    XCTAssertEqual(rows[1].prefetchedRows["ds"]![2], ["cold1": 13, "cold2": 9, "cold3": "d4", "sqldb_colc2": 2])
                ...
                do {
                    ...
                    XCTAssertEqual(row.prefetchedRows["ds"]![0], ["cold1": 10, "cold2": 7, "cold3": "d1", "sqldb_colc2": 1])
                }
            }
            ...
            do {
                ...
                do {
                    ...
                    XCTAssertEqual(rows[0].prefetchedRows["ds2"]![0], ["cold1": 10, "cold2": 7, "cold3": "d1", "sqldb_colc2": 1])
                    ...
                    XCTAssertEqual(rows[1].prefetchedRows["ds1"]![0], ["cold1": 11, "cold2": 8, "cold3": "d2", "sqldb_colc2": 2])
                    XCTAssertEqual(rows[1].prefetchedRows["ds1"]![1], ["cold1": 12, "cold2": 8, "cold3": "d3", "sqldb_colc2": 2])
                    XCTAssertEqual(rows[1].prefetchedRows["ds2"]!.count, 2)
                    XCTAssertEqual(rows[1].prefetchedRows["ds2"]![0], ["cold1": 12, "cold2": 8, "cold3": "d3", "sqldb_colc2": 2])
                    XCTAssertEqual(rows[1].prefetchedRows["ds2"]![1], ["cold1": 13, "cold2": 9, "cold3": "d4", "sqldb_colc2": 2])
                    XCTAssertEqual(rows[1].prefetchedRows["ds3"]!.count, 1)
                    XCTAssertEqual(rows[1].prefetchedRows["ds3"]![0], ["cold1": 11, "cold2": 8, "cold3": "d2", "sqldb_colc2": 2])
                }
                ...
                do {
                    ...
                    XCTAssertEqual(row.prefetchedRows["ds2"]![0], ["cold1": 10, "cold2": 7, "cold3": "d1", "sqldb_colc2": 1])
        ...
        try dbQueue.read { db in
            ...
            do {
                ...
                do {
                    ...
                    XCTAssertEqual(rows[0].prefetchedRows.keys, ["cs"])
                    XCTAssertEqual(rows[0].prefetchedRows["cs"]!.count, 1)
                    XCTAssertEqual(rows[0].prefetchedRows["cs"]![0], ["colc1": 7, "colc2": 1, "sqldb_cola1": 1])
                    ...
                    XCTAssertEqual(rows[1].prefetchedRows["cs"]![0], ["colc1": 7, "colc2": 1, "sqldb_cola1": 1])
                    ...
                    XCTAssertEqual(rows[2].prefetchedRows["cs"]![0], ["colc1": 8, "colc2": 2, "sqldb_cola1": 2])
                    XCTAssertEqual(rows[2].prefetchedRows["cs"]![1], ["colc1": 9, "colc2": 2, "sqldb_cola1": 2])
                ...
                do {
                    ...
                    XCTAssertEqual(row.prefetchedRows.keys, ["cs"])
                    XCTAssertEqual(row.prefetchedRows["cs"]!.count, 1)
                    XCTAssertEqual(row.prefetchedRows["cs"]![0], ["colc1": 7, "colc2": 1, "sqldb_cola1": 1])
        ...
        try dbQueue.write { db in
            ...
            do {
                ...
                do {
                    ...
                    XCTAssertEqual(rows[0].scopes["a"]!.prefetchedRows["cs"]![0], ["colc1": 7, "colc2": 1, "sqldb_cola1": 1])
                    ...
                    XCTAssertEqual(rows[1].scopes["a"]!.prefetchedRows["cs"]![0], ["colc1": 7, "colc2": 1, "sqldb_cola1": 1])
                    ...
                    XCTAssertEqual(rows[2].scopes["a"]!.prefetchedRows["cs"]![0], ["colc1": 8, "colc2": 2, "sqldb_cola1": 2])
                    XCTAssertEqual(rows[2].scopes["a"]!.prefetchedRows["cs"]![1], ["colc1": 9, "colc2": 2, "sqldb_cola1": 2])
                ...
                do {
                    ...
                    XCTAssertEqual(row.scopes["a"]!.prefetchedRows["cs"]![0], ["colc1": 7, "colc2": 1, "sqldb_cola1": 1])
                }
            }
            ...
            do {
                ...
                do {
                    ...
                    XCTAssertEqual(rows[0].scopes["a1"]!.prefetchedRows["cs2"]![0], ["colc1": 7, "colc2": 1, "sqldb_cola1": 1])
                    ...
                    XCTAssertEqual(rows[1].scopes["a1"]!.prefetchedRows["cs2"]![0], ["colc1": 7, "colc2": 1, "sqldb_cola1": 1])
                    ...
                    XCTAssertEqual(rows[2].scopes["a2"]!.prefetchedRows["cs1"]![0], ["colc1": 9, "colc2": 2, "sqldb_cola1": 2])
                    XCTAssertEqual(rows[2].scopes["a2"]!.prefetchedRows["cs2"]!.count, 1)
                    XCTAssertEqual(rows[2].scopes["a2"]!.prefetchedRows["cs2"]![0], ["colc1": 8, "colc2": 2, "sqldb_cola1": 2])
                ...
                do {
                    ...
                    XCTAssertEqual(row.scopes["a1"]!.prefetchedRows["cs2"]![0], ["colc1": 7, "colc2": 1, "sqldb_cola1": 1])
        ...
        try dbQueue.write { db in
            ...
            do {
                ...
                do {
                    ...
                    XCTAssertEqual(rows[0].prefetchedRows.keys, ["bs"])
                    XCTAssertEqual(rows[0].prefetchedRows["bs"]!.count, 2)
                    XCTAssertEqual(rows[0].prefetchedRows["bs"]![0], ["colb1": 4, "colb2": 1, "colb3": "b1", "sqldb_colc1": 7])
                    XCTAssertEqual(rows[0].prefetchedRows["bs"]![1], ["colb1": 5, "colb2": 1, "colb3": "b2", "sqldb_colc1": 7])
                    XCTAssertEqual(rows[0].scopes.count, 0)

                    XCTAssertEqual(rows[1].unscoped, ["cold1": 11, "cold2": 8, "cold3": "d2"])
                    XCTAssertEqual(rows[1].prefetchedRows.keys, ["bs"])
                    XCTAssertEqual(rows[1].prefetchedRows["bs"]!.count, 1)
                    XCTAssertEqual(rows[1].prefetchedRows["bs"]![0], ["colb1": 6, "colb2": 2, "colb3": "b3", "sqldb_colc1": 8])
                    ...
                    XCTAssertEqual(rows[2].prefetchedRows["bs"]![0], ["colb1": 6, "colb2": 2, "colb3": "b3", "sqldb_colc1": 8])
                    ...
                    XCTAssertEqual(rows[3].prefetchedRows["bs"]![0], ["colb1": 6, "colb2": 2, "colb3": "b3", "sqldb_colc1": 9])
                ...
                do {
                    ...
                    XCTAssertEqual(row.prefetchedRows.keys, ["bs"])
                    XCTAssertEqual(row.prefetchedRows["bs"]!.count, 2)
                    XCTAssertEqual(row.prefetchedRows["bs"]![0], ["colb1": 4, "colb2": 1, "colb3": "b1", "sqldb_colc1": 7])
                    XCTAssertEqual(row.prefetchedRows["bs"]![1], ["colb1": 5, "colb2": 1, "colb3": "b2", "sqldb_colc1": 7])
    ...
    func testEquatable() throws {
        ...
        try dbQueue.read { db in
            ...
            XCTAssertEqual(row2.prefetchedRows["bs"], [
                ["colb1": 4, "colb2": 1, "colb3": "b1", "sqldb_colb2": 1],
                ["colb1": 5, "colb2": 1, "colb3": "b2", "sqldb_colb2": 1]])
        ...
        try dbQueue.inDatabase { db in
            ...
            for (index, row) in rows.enumerated() {
                ...
                XCTAssertEqual(
                    ...
                    ["a": index, "b": 1, "sqldb_a": index, "sqldb_b": 1])
            }
        }
    }
}
