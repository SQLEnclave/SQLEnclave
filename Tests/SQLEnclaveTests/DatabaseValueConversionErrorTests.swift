...
class DatabaseValueConversionErrorTests: SQLEnclaveTestCase {
    func testFetchableRecord1() throws {
        struct Record /* TODO SQLEnclave6: FetchableRecord */ {
            var name: String
        ...
        try dbQueue.read { db in
            ...
            do {
                // TODO SQLEnclave6: _ = try Record.fetchOne(statement)
    ...
    func testDecodableFetchableRecord1() throws {
        ...
        try dbQueue.read { db in
            ...
            do {
                let row = try Row.fetchOne(statement)!
                // TODO SQLEnclave6: _ = try Record(row: row)
    ...
    func testStatementColumnConvertible1() throws {
        ...
        try dbQueue.read { db in
            ...
            do {
                // TODO SQLEnclave6: _ = try String.fetchAll(statement)
                _ = try Row.fetchCursor(statement)
    ...
    func testStatementColumnConvertible2() throws {
        ...
        try dbQueue.read { db in
            ...
            do {
                // TODO SQLEnclave6: _ = try Int8.fetchAll(statement)
                _ = try Row.fetchCursor(statement)
    ...
    func testDecodableDatabaseValueConvertible() throws {
        ...
        try dbQueue.read { db in
            ...
            do {
                // TODO SQLEnclave6: _ = try Value.fetchAll(statement)
                _ = try Row.fetchCursor(statement)
            ...
            do {
                // TODO SQLEnclave6: _ = try Value.fetchOne(statement, adapter: SuffixRowAdapter(fromIndex: 1))
                _ = try Row.fetchCursor(statement)
